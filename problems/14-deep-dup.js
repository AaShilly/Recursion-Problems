...
function deepDup(arr){
  // Base case: If the element of the array is not an array it will be returned
  if (!Array.isArray(arr)){
    return arr;
  }

  // Recursive case: Iterates over each element and creates a deep copy if that element is an array/object
  return arr.map(element => deepDup(element));
}
